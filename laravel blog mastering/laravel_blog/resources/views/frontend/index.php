...
<html lang="en">
  ...
  <div class="container">
	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane active" id="featured-item">
	    ...
	    <img class="slide-img" src="assets/img/iphone.png"/>
	  </div>
	  <div role="tabpanel" class="tab-pane" id="best-seller">
	    ...
	    <img class="slide-img" src="assets/img/xbox.png"/>
	  </div>	    
	  <div role="tabpanel" class="tab-pane" id="discount">
	    ...
	    <img class="slide-img" src="assets/img/ps4.png"/>
	  </div>
	  <div role="tabpanel" class="tab-pane" id="premium">
	    ...
	    <img class="slide-img" src="assets/img/surface.png"/>
	  </div>
	...
	<div class="col-md-4">
	  <div class="thumbnail">
	    <img src="assets/img/surface.png">
	    <div class="caption">
  ...
  <footer>
    <p>MyStore Copyright &copy; 2019 - Developer by mamuncet27 <a href="#">Terms</a> &middot; <a href="#">Privacy</a></p>
  </footer>  

    <!-- Bootstrap core JavaScript
    ================================================== -->
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="assets/https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
